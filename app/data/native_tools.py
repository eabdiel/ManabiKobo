...
def get_native_tool(slug: str, lang: str) -> dict:
    ...
    labels = {
      ...
      'audio-companion': ('Michel Thomas Method Companion','Compañero del Método Michel Thomas','Post-course review tools for learners who have completed their Michel Thomas Japanese audio material.','Herramientas de repaso posterior al curso para estudiantes que ya completaron su material de audio de Michel Thomas Japanese.'),
