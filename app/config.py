"""=============================================================================
Manabi Kobo application configuration
=============================================================================
Purpose:
...
class Config:
    ...
    AI_COMPANION_ENABLED = os.getenv("MK_AI_COMPANION_ENABLED", "true").lower() in {"1", "true", "yes", "on"}
    AI_COMPANION_BOT_ID = os.getenv("MK_AI_COMPANION_BOT_ID", "59258")
